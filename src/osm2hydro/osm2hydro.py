...
def main(opts):
    ...
    try:
        ...
        logger.info('$Id: OSM2hydro.py 798 2013-10-02 07:11:23Z schelle $')
        logger.info('$Date: 2013-10-02 09:11:23 +0200 (Wed, 02 Oct 2013) $')
        logger.info('$Author: schelle $')
        logger.info('$Revision: 798 $')
    ...
    if run_osm:
        ...
        if method_poly:
            ...
            gdal_density.main(['-G','True','-S',lu_waterway_canal_shp,'-b',str(width_waterway_canal),'-E',str('[%f,%f,%f,%f]') % (xmin, ymin, xmax, ymax),'-C',str(resolution),'-o', lu_waterway_canal_tif, '-F', 'GTiff','-r',str(resamp_grid_method)])
            gdal_density.main(['-G','True','-S',lu_waterway_ditch_shp,'-b',str(width_waterway_ditch),'-E',str('[%f,%f,%f,%f]') % (xmin, ymin, xmax, ymax),'-C',str(resolution),'-o', lu_waterway_ditch_tif, '-F', 'GTiff','-r',str(resamp_grid_method)])
            gdal_density.main(['-G','True','-S',lu_waterway_drain_shp,'-b',str(width_waterway_drain),'-E',str('[%f,%f,%f,%f]') % (xmin, ymin, xmax, ymax),'-C',str(resolution),'-o', lu_waterway_drain_tif, '-F', 'GTiff','-r',str(resamp_grid_method)])
            gdal_density.main(['-G','True','-S',lu_roads_main_shp,'-b',str(width_road_main),'-E',str('[%f,%f,%f,%f]') % (xmin, ymin, xmax, ymax),'-C',str(resolution),'-o', lu_roads_main_tif, '-F', 'GTiff','-r',str(resamp_grid_method)])
            gdal_density.main(['-G','True','-S',lu_roads_sec_shp,'-b',str(width_road_sec),'-E',str('[%f,%f,%f,%f]') % (xmin, ymin, xmax, ymax),'-C',str(resolution),'-o', lu_roads_sec_tif, '-F', 'GTiff','-r',str(resamp_grid_method)])
            gdal_density.main(['-G','True','-S',lu_roads_small_shp,'-b',str(width_road_small),'-E',str('[%f,%f,%f,%f]') % (xmin, ymin, xmax, ymax),'-C',str(resolution),'-o', lu_roads_small_tif, '-F', 'GTiff','-r',str(resamp_grid_method)])
            gdal_density.main(['-G','True','-S',lu_roads_track_shp,'-b',str(width_road_track),'-E',str('[%f,%f,%f,%f]') % (xmin, ymin, xmax, ymax),'-C',str(resolution),'-o', lu_roads_track_tif, '-F', 'GTiff','-r',str(resamp_grid_method)])
